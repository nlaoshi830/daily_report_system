...
public class EmployeeValidator {
    ...
    public static List<String> validate(Employee e, Boolean code_duplicate_check_flag, Boolean password_check_flag){
        ...
        String password_error = _validatePassoword(e.getPassword(), password_check_flag);
    ...
    private static String _validatePassoword(String password, Boolean password_check_flag){
